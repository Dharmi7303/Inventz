    ...
    return (
        <div className="item-selection-container">
            <div className="top-articles">
                <label className="provider-item-label">Select articles{provider ? " del proveedor " + provider.name : ""}</label>
                            ...
                            {paginator.articles && paginator.articles.length > 0 ? (
                                paginator.articles.map(article => (
                                    <tr key={article.articleId}>
                                        ...
                                        <td>{article.stock}</td>
                                        <td>{article.purchasePrice.toLocaleString('es-IN', { style: 'currency', currency: 'INR' })}</td>
                                        <td>{article.salePrice.toLocaleString('es-IN', { style: 'currency', currency: 'INR' })}</td>
                            ...
                            <tbody>
                                {articles && articles.map(article => (
                                    <tr key={article.articleId}>
                                        ...
                                        <td>{article.purchasePrice.toLocaleString('es-IN', { style: 'currency', currency: 'INR' })}</td>
                                        <td>{(article.purchasePrice * article.quantity).toLocaleString('es-IN', { style: 'currency', currency: 'INR' })}</td>
                                        <td>
                                ...
                                <tr>
                                    ...
                                    <td className="total">{calculateTotal().toLocaleString('es-IN', { style: 'currency', currency: 'INR' })}</td>
                                    <td></td>
                                </tr>
                            </tbody>
                        </table>
