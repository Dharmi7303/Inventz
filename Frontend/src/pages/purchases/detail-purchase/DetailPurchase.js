                            ...
                            <tbody>
                                {purchase && purchase.purchaseArticles.map(articleData => (
                                    <tr key={articleData.article.articleId}>
                                        ...
                                        <td>{(articleData.price / articleData.articleQuantity).toLocaleString('es-IN', { style: 'currency', currency: 'INR' })}</td>
                                        <td>{articleData.price.toLocaleString('es-IN', { style: 'currency', currency: 'INR' })}</td>
                                    </tr>
                                ))}
                                {purchase &&
                                    <tr>
                                        ...
                                        <td className="total">{purchase.totalValue.toLocaleString('es-IN', { style: 'currency', currency: 'INR' })}</td>
                                    </tr>}
                            </tbody>
                        </table>
                    </div>
